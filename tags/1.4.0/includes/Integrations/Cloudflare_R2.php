...
class Cloudflare_R2 extends S3_Provider {
	...
	public function credentialsField() {
		$requiredConstants = [
			'ADVMO_CLOUDFLARE_R2_KEY' => __( 'ADVMO_CLOUDFLARE_R2_KEY', 'advanced-media-offloader' ),
			'ADVMO_CLOUDFLARE_R2_SECRET' => __( 'ADVMO_CLOUDFLARE_R2_SECRET', 'advanced-media-offloader' ),
			'ADVMO_CLOUDFLARE_R2_ENDPOINT' => __( 'ADVMO_CLOUDFLARE_R2_ENDPOINT', 'advanced-media-offloader' ),
			'ADVMO_CLOUDFLARE_R2_BUCKET' => __( 'ADVMO_CLOUDFLARE_R2_BUCKET', 'advanced-media-offloader' ),
			'ADVMO_CLOUDFLARE_R2_DOMAIN' => __( 'ADVMO_CLOUDFLARE_R2_DOMAIN', 'advanced-media-offloader' ),
		];
